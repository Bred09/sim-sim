		...
		$.ajax({
			...
			success: function(responce){
				if(responce>0){
					...
					$('body').prepend($('<a href="/personal/profile/chat/" class="top-position-chat-notification-block">У вас '+responce+' новых сообщений в чатах</a>'));
/*					
					$('.show-chat').each(function(i,elem){
						$(elem).find('span').remove();
					})
*/					
			...
			$.ajax({
				...
				success: function(responce){
					if(responce){
						...
						alert('Чат c '+name_chat+' удален!');
					}else{
						alert('Чат c '+name_chat+' НЕ удален!'+"\n"+'Попробуйте позже либо обратитесь к менеджеру!');
					}
				}
			});
	...
	$('.system-auth-authorize-registration-button.intec-ui.intec-ui-control-button.intec-ui-mod-round-3.intec-ui-scheme-current.intec-ui-size-2').after('<br><br><a href="/auth-torg/" class="system-auth-authorize-registration-button intec-ui intec-ui-control-button intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-2">Стать поставщиком</a>');
